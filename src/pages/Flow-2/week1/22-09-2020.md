...
Work through the videos below as todays exercise and write down questions. It is important that you code along all the way.
...
- [:tv: JPA Project Setup](https://youtu.be/3czFeaqCUfE)
- [:tv: JPA OneToOne relations](https://youtu.be/UI8CmAXxSxY)
- [:tv: JPA OneToMany relations](https://youtu.be/SNhOa7mkdaI)
